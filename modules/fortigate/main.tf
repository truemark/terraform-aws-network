...
resource "null_resource" "validation_check_subnet_cidr" {
  ...
  <<EOT
    ...
    The format should be follow the name prefix of \"fgt_login_\", \"fgt_internal_\", \"tgw_attachment_\", \"gwlbe_\", \"ngw_\", \"privatelink_\". Specify the target subnet you needed."
  EOT
  ) : 0
}
...
module "security-vpc" {
  source  = "fortinetdev/cloud-modules/aws//modules/aws/vpc"
  version = "1.1.1"
...
module "security_route_table" {
  source  = "fortinetdev/cloud-modules/aws//modules/aws/vpc_route_table"
  version = "1.1.1"
...
module "transit-gw" {
  source  = "fortinetdev/cloud-modules/aws//modules/aws/tgw"
  version = "1.1.1"
...
#   source  = "fortinetdev/cloud-modules/aws//modules/aws/tgw_route_table"
#   version = "1.1.1"
...
module "fgt_asg" {
  source  = "fortinetdev/cloud-modules/aws//modules/fortigate/fgt_asg"
  version = "1.1.1"
  for_each = var.asgs
...
# Create Nat Gateways
module "ngw" {
  source  = "fortinetdev/cloud-modules/aws//modules/aws/nat_gateway"
  version = "1.1.1"
...
module "security-vpc-gwlb" {
  source  = "fortinetdev/cloud-modules/aws//modules/aws/gwlb"
  version = "1.1.1"
